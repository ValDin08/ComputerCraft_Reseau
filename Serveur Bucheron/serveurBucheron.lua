--Déclaration des variables
	--Globales
	local ServerVersion	=	"3.0"		--Version du serveur
	...
	--Ecran
	local ScreenSide			=	"left"		--Côté de l'écran
	
	--Commandes
	local RedstoneInputSide		=	"bottom"	--Côté de l'entrée du signal redstone	
...
while true do
	...
	HMI.write("Nombre d'arbres abattus : "..HarvestedTrees)	
